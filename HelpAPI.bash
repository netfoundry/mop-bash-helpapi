...
function RunEventReport() {
	...
	while true; do
		...
		ReportBegin=( "0 Days Ago" "1 Day Ago" "7 Days Ago" "14 Days Ago" "30 Days Ago" "60 Days Ago" "90 Days Ago" )
